               ...
               <!--  <a href="users.php"> -->
                ...
                <i class="fa fa-angle-left pull-right"></i>
                 ...
                 <ul class="treeview-menu">
                  ...
                  <li><a href="activeuser.php"><i class="fa fa-angle-right"></i> Active Users</a></li>
                  <li><a href="activeuser.php"><i class="fa fa-angle-right"></i> Users With Subscriptions</a></li>
                </ul>
                <!-- </a> -->
...
{  
    ...
    {	echo "<tr>";
       ...
       echo "<td><input type='submit' value='Edit' class='btn btn-primary'> <input type='submit' value='Delete' class='btn btn-primary'></td></tr>";
    }
}
